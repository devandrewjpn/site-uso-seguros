                        ...
                        <div className="col-xxl-6 col-xl-6 col-xl-6 col-md-6">
                            <div className="pt-0 about__content-6">
                                ...
                                <h3 className="sec-title underline-2 text-white">
                                    Por que contratar a Assistência Saúde USO?
                                </h3>
                                <p>Experimente a tranquilidade de ter assistência médica qualificada sempre disponível, sem filas e com toda a privacidade que você merece.</p>
